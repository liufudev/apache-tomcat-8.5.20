...
function callback(page,next) {
    ...
    for (var i = 0; i < data.length; i++) {
    	var reporterName='';
		if(data[i].infoReporterList.length>0){
			reporterName= data[i].infoReporterList[0].reporterName 
			reporterName='<a href="author-list.html">' +reporterName + '</a>'
		}
		 var summary=data[i].summary;
	     var  str = '<li><div class="BoxB" > <div class="summary"><h2 _collectionUid="' + data[i].collectionUid + '" _href="' + data[i].infoId + '">' + data[i].infoTitle + '</h2> <p class="text_main">' + summary + '</p></div></div><div class="authorBox"><div class="hr"></div><span class="See"><i class="icon iconSee"></i>' + data[i].infoReadCount + '</span><span class="Time"><i class="icon iconTime"></i>' + formatDate2(data[i].publishTime) + '</span><span class="Author">'+reporterName+'</span></div></li>';
	     lis.push(str);
	    }
